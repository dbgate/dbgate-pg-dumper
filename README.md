...
The structured-archive native restore boundary, planner, target inspection,
transactions, progress, diagnostics, and current execution skeleton are
documented in [Native PostgreSQL restore architecture](docs/native-restore.md).
